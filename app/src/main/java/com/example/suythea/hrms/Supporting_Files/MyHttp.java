...
//    private String loadingMessage = "Loading...";
    ...
    public MyHttp(Context context, AsyncResponse asyncResponse) {
        this.asyncResponse = asyncResponse;
        this.context = context;
    }

    public MyHttp(Context context, boolean showLoadingMessage, AsyncResponse asyncResponse) {
        this.asyncResponse = asyncResponse;
        this.context = context;
//        this.showLoadingMessage = showLoadingMessage;
    }

    public MyHttp(Context context, HashMap<String, String> postData, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
        this.asyncResponse = asyncResponse;
    }

    public MyHttp(Context context, HashMap<String, String> postData, boolean showLoadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
        this.asyncResponse = asyncResponse;
//        this.showLoadingMessage = showLoadingMessage;
    ...
    public MyHttp(Context context, String loadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
//        this.loadingMessage = loadingMessage;
        this.asyncResponse = asyncResponse;
    }

    public MyHttp(Context context, HashMap<String, String> postData, String loadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
//        this.loadingMessage = loadingMessage;
        this.asyncResponse = asyncResponse;
