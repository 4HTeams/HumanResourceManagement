...
public class MainViewOwnCV extends AppCompatActivity implements MySupporter_Interface, ViewOwn_Job_CV_Interface {
    ...
    int deletingID;
    int selectedID;
    ArrayList<ListViewOwnCVModel> listCVModels;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_view_own_cv);
    ...
    void startUp(){
        ...
        adp = new ListViewOwnCVAdp(this, R.layout.list_own_cv_item, listCVModels);
    ...
    public void onVolleyFinished(String response) {
        ...
        try {
            ...
            for(int i = 0; i< jsonData.length(); i++){
                ListViewOwnCVModel cvModel = new ListViewOwnCVModel(jsonData.getJSONObject(i).getString("fName"), jsonData.getJSONObject(i).getString("lName"), jsonData.getJSONObject(i).getString("posted_date"), jsonData.getJSONObject(i).getString("title"));
    ...
    public void reloadChangedData(Object object) {
        try {
            ...
            jsonData = jsonArray;
            ListViewOwnCVModel cvModel = new ListViewOwnCVModel(jsonData.getJSONObject(selectedID).getString("fName"), jsonData.getJSONObject(selectedID).getString("lName"), jsonData.getJSONObject(selectedID).getString("posted_date"), jsonData.getJSONObject(selectedID).getString("title"));
